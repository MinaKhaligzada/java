public class Homework13 {
    ...
    public static void checkPositiveNumber() { int a =5;
        if (a>0);
    ...
    public static void checkEvenOrOdd() { int a =4;
        if ( a % 4 == 0) System.out.println("The number is even.");
    ...
    public static void categorizeAge( ) { int age = 25;

        if (0 <= age && age <= 12) {
            System.out.println("Child");}
            else if (13<= age && age <= 19) {
                System.out.println("Teenager");}
                else if (20 <= age && age <= 25) {System.out.println("Adult");}
                else if (age >= 65) {
